...
From the study of various papers and the implemntation of many algorithms we came to the conclusion most of the time sequential algorithms out perform MapReduce.
MapReduce needs a lot of data in order to balance the trade off using a distributed computing. Our datasets was not large enough to take advantage of MapReduce.
